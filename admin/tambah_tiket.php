...
<head>
  ...
  <body>
   ...
   <div class="container mt-3"><nav aria-label="breadcrumb">
    ...
    <div class="container">
    <h1 class="mt-3"> Tambah Tiket</h1>
    <form action="simpan_tiket.php" method="POST" class="">
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" name="nama_tiket" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>
  <div class="mb-3">
