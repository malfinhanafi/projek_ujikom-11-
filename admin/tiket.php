        ...
        if(mysqli_num_rows($query)){
            ...
            while ($result=mysqli_fetch_assoc($query)){
                ...
                <tr >
                    ...
                    <td>
                        <a href="edit_tiket.php?id_tiket=<?php echo $result['id_tiket']?>" class="btn btn-warning"> Edit</a>
                        <a href="hapus_tiket.php?id_tiket=<?php echo $result['id_tiket']?>" onclick="return confirm('kamu yakin mau hapus?')" class="btn btn-danger">Hapus</a>
                    </td>
                </tr>
                <?php
                $no++;
