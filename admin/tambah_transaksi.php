...
<head>
  ...
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">ID Admin</label> </label>
    <input type="text" class="form-control" name="id_admin" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>
  <div class="mb-3">
