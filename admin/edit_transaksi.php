...
<?php require "navbar.php"?>
  <body>
    ...
    ?>
    <form action="proses_edit_transaksi.php?no_rekening=<?php echo $result['no_rekening']?>" method="POST">
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">ID Tiket </label>
    <input type="number" class="form-control" value="<?php echo $result['id_tiket']?>" name="id_tiket" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">ID Pembeli</label> </label>
    <input type="number" class="form-control" value="<?php echo $result['id_pembeli']?>" name="id_pembeli" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>
  <div class="mb-3">
