  ...
  <div class="login">
    <div class="loginBx">
                <div>
                    ...
                    <input type="text"placeholder="Email/Number/Username" class="form-control" name="username" id="username">
                </div>
                <div>
        ...
        <div class="mt-3" style="width: 500px;">
            ...
            if(isset($_POST['loginbtn'])){
                ...
                $query = mysqli_query($conn ,"SELECT * FROM pembeli WHERE username='$username'");
                ...
                if (password_verify($password,$data['password'])){
                    ...
                    ?>
                    <div class="alert alert-warning" role="alert">Yah Gagal</div>
                    <?php
                }
            }
            ?>
